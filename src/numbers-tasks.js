...
function getAverage(value1, value2) {
  return (value1 + value2) / 2 > Number.MAX_VALUE
    ? Number.MAX_VALUE - 1
    : (value1 + value2) / 2;
}
...
// found an idea for a solution here: https://www.cuemath.com/geometry/angle-between-vectors/
...
function getCountOfOddNumbers(number) {
  return [...Array(Math.abs(number) + 1).keys()].reduce((acc, current) => {
